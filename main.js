function preload(){
    window.alert("You have to draw a specific sketch which is being instructed by the app.This game app will be based on time constraints and this will give the score for each right sketch drawn by the you. You can see different sketches by clicking on the Show Sketches button.");
}
function setup(){
...
document.getElementById("object").value = sketch;
